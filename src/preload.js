...
contextBridge.exposeInMainWorld("monstro", {
  ...
  mailStartLogin: () => ipcRenderer.invoke("mail:startLogin"),
  ...
  sessionsTag: (sessionId, url) => ipcRenderer.invoke("sessions:tag", { sessionId, url }),
  sessionsUntag: (sessionId, key) => ipcRenderer.invoke("sessions:untag", { sessionId, key }),
  ...
  mrCommits: (repo, number) => ipcRenderer.invoke("pr:mrCommits", { repo, number }),
